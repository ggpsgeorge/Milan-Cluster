(function (global, factory) {
  ...
  var ErrorBarsPlugin = {
     ...
     */
    _resolveScale: function _resolveScale(chart, horizontal, i) {
      var xAxisId = chart.data.datasets[i].xAxisID || 'x-axis-0';
      var yAxisId = chart.data.datasets[i].yAxisID || 'y-axis-0';
      var scaleId = horizontal ? xAxisId : yAxisId;
    ...
    afterDatasetsDraw: function afterDatasetsDraw(chart, easingValue, options) {
      ...
      barchartCoords.forEach(function (dataset, i) {
        var vScale = _this._resolveScale(chart, horizontal, i);
        ...
        dataset.forEach(function (bar) {
          ...
          var hasLabelProperty = Object.hasOwnProperty.call(cur, bar.label);
